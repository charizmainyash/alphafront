...
export const Contact = () => {
  ...
  return (
    <div className="bg-black text-white p-2 w-full h-full">
      ...
      <div className="">
        <h1
          className={`c-main-text my-5 text-center font-extrabold text-8xl text-transform:uppercase ${
      ...
      <div className={`c-form-text flex ${showText ? "animated" : ""}`}>
        ...
        <div className="c-form w-1/2 p-5">
          <h1 className="text-2xl text-center my-5 ">
            {flag ? 'Our Team will Get to You Soon ✅' : ''}
            {err ? 'Something Went Wrong , Try Again' : ''}
            {flag || err ? '' : 'Book  a  FREE  Strategy  Session ⚡️'}
          </h1>
